...
export const WEAPON_BALANCE: Record<WeaponId, WeaponBalance> = {
  ...
  sg552: { id: 'sg552', name: 'SG 552', price: 3000, teams: ['attackers'], buyCategory: 'rifle', killReward: 300, damage: 34, fireRate: 9.5, magazineSize: 30, maxReserveAmmo: 90, reloadTime: 2.4, spread: 0.048, movementSpeedMultiplier: 0.88, armorPenetration: 0.76, headshotMultiplier: 4, range: 95, recoilKick: 1.1, moveInaccuracy: 0.11 },
  ...
  sg550: { id: 'sg550', name: 'SG 550', price: 5000, teams: ['defenders'], buyCategory: 'sniper', killReward: 100, damage: 80, fireRate: 3, magazineSize: 20, maxReserveAmmo: 60, reloadTime: 3.2, spread: 0.025, movementSpeedMultiplier: 0.78, armorPenetration: 0.95, headshotMultiplier: 1.8, range: 115, recoilKick: 1.5, moveInaccuracy: 0.15 },
  ...
  tmp: { id: 'tmp', name: 'TMP', price: 1250, teams: ['defenders'], buyCategory: 'smg', killReward: 600, damage: 20, fireRate: 14, magazineSize: 30, maxReserveAmmo: 120, reloadTime: 2.1, spread: 0.075, movementSpeedMultiplier: 0.98, armorPenetration: 0.55, headshotMultiplier: 2.6, range: 44, recoilKick: 0.75, moveInaccuracy: 0.08 },
