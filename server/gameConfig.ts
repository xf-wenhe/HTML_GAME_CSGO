...
export const WEAPON_BALANCE: Record<WeaponId, WeaponBalance> = {
  ...
  sidearm: { id: 'sidearm', name: 'Glock-18', price: 200, teams: 'both', buyCategory: 'pistol', killReward: 300, damage: 25, fireRate: 5, magazineSize: 20, maxReserveAmmo: 120, reloadTime: 2.2, spread: 0.04, movementSpeedMultiplier: 1, armorPenetration: 0.47, headshotMultiplier: 3.5, range: 48, recoilKick: 0.8, moveInaccuracy: 0.05 },
  ...
  knife: { id: 'knife', name: 'Tactical Knife', price: 0, teams: 'both', buyCategory: 'melee', killReward: 1500, damage: 15, fireRate: 1.8, magazineSize: 1, maxReserveAmmo: 0, reloadTime: 0, spread: 0, movementSpeedMultiplier: 1, armorPenetration: 0.2, headshotMultiplier: 1, range: 2.4, recoilKick: 0, moveInaccuracy: 0 },
  // New weapons
  glock: { id: 'glock', name: 'Glock-18', price: 400, teams: ['attackers'], buyCategory: 'pistol', killReward: 300, damage: 25, fireRate: 5, magazineSize: 20, maxReserveAmmo: 120, reloadTime: 2.2, spread: 0.04, movementSpeedMultiplier: 1, armorPenetration: 0.47, headshotMultiplier: 3.5, range: 48, recoilKick: 0.8, moveInaccuracy: 0.05 },
  pistol: { id: 'pistol', name: 'Glock-18', price: 200, teams: 'both', buyCategory: 'pistol', killReward: 300, damage: 25, fireRate: 5, magazineSize: 20, maxReserveAmmo: 120, reloadTime: 2.2, spread: 0.04, movementSpeedMultiplier: 1, armorPenetration: 0.47, headshotMultiplier: 3.5, range: 48, recoilKick: 0.8, moveInaccuracy: 0.05 },
  ...
  p228: { id: 'p228', name: 'P228', price: 600, teams: 'both', buyCategory: 'pistol', killReward: 300, damage: 32, fireRate: 4.5, magazineSize: 13, maxReserveAmmo: 52, reloadTime: 2.2, spread: 0.04, movementSpeedMultiplier: 1, armorPenetration: 0.52, headshotMultiplier: 3.5, range: 50, recoilKick: 0.8, moveInaccuracy: 0.05 },
  five_seven: { id: 'five_seven', name: 'Five-SeveN', price: 750, teams: ['defenders'], buyCategory: 'pistol', killReward: 300, damage: 20, fireRate: 5, magazineSize: 20, maxReserveAmmo: 100, reloadTime: 2.7, spread: 0.012, movementSpeedMultiplier: 1, armorPenetration: 0.91, headshotMultiplier: 3, range: 55, recoilKick: 0.7, moveInaccuracy: 0.03 },
  deagle: { id: 'deagle', name: 'Desert Eagle', price: 650, teams: 'both', buyCategory: 'pistol', killReward: 300, damage: 54, fireRate: 2.2, magazineSize: 7, maxReserveAmmo: 35, reloadTime: 2.2, spread: 0.05, movementSpeedMultiplier: 0.95, armorPenetration: 0.93, headshotMultiplier: 3.2, range: 65, recoilKick: 1.35, moveInaccuracy: 0.08 },
  dual_berettas: { id: 'dual_berettas', name: 'Dual Elites', price: 800, teams: ['attackers'], buyCategory: 'pistol', killReward: 300, damage: 36, fireRate: 5, magazineSize: 30, maxReserveAmmo: 120, reloadTime: 4.5, spread: 0.012, movementSpeedMultiplier: 1, armorPenetration: 0.45, headshotMultiplier: 3, range: 52, recoilKick: 0.65, moveInaccuracy: 0.06 },
  ...
  ump45: { id: 'ump45', name: 'UMP-45', price: 1700, teams: 'both', buyCategory: 'smg', killReward: 300, damage: 30, fireRate: 9, magazineSize: 25, maxReserveAmmo: 100, reloadTime: 2.3, spread: 0.07, movementSpeedMultiplier: 0.98, armorPenetration: 0.65, headshotMultiplier: 2.6, range: 46, recoilKick: 0.8, moveInaccuracy: 0.07 },
  p90: { id: 'p90', name: 'P90', price: 2350, teams: 'both', buyCategory: 'smg', killReward: 300, damage: 21, fireRate: 16, magazineSize: 50, maxReserveAmmo: 100, reloadTime: 2.6, spread: 0.009, movementSpeedMultiplier: 0.98, armorPenetration: 0.69, headshotMultiplier: 2.4, range: 52, recoilKick: 0.75, moveInaccuracy: 0.06 },
  ...
  scout: { id: 'scout', name: 'Scout', price: 2750, teams: 'both', buyCategory: 'sniper', killReward: 300, damage: 75, fireRate: 1.1, magazineSize: 10, maxReserveAmmo: 90, reloadTime: 2.6, spread: 0.02, movementSpeedMultiplier: 0.85, armorPenetration: 0.8, headshotMultiplier: 4, range: 115, recoilKick: 1.5, moveInaccuracy: 0.2 },
  ...
  g3sg1: { id: 'g3sg1', name: 'G3SG1', price: 5000, teams: ['attackers'], buyCategory: 'sniper', killReward: 300, damage: 80, fireRate: 3, magazineSize: 20, maxReserveAmmo: 90, reloadTime: 3.2, spread: 0.025, movementSpeedMultiplier: 0.78, armorPenetration: 0.95, headshotMultiplier: 1.8, range: 115, recoilKick: 1.5, moveInaccuracy: 0.15 },
  sg550: { id: 'sg550', name: 'SG 550', price: 4200, teams: ['defenders'], buyCategory: 'sniper', killReward: 300, damage: 70, fireRate: 3, magazineSize: 30, maxReserveAmmo: 90, reloadTime: 3.2, spread: 0.025, movementSpeedMultiplier: 0.78, armorPenetration: 0.95, headshotMultiplier: 1.8, range: 115, recoilKick: 1.5, moveInaccuracy: 0.15 },
  ...
  xm1014: { id: 'xm1014', name: 'XM1014', price: 3000, teams: 'both', buyCategory: 'shotgun', killReward: 300, damage: 20, fireRate: 1.8, magazineSize: 7, maxReserveAmmo: 32, reloadTime: 3, spread: 0.2, movementSpeedMultiplier: 0.86, armorPenetration: 0.25, headshotMultiplier: 1.5, range: 24, recoilKick: 1.5, moveInaccuracy: 0.15 },
  m3: { id: 'm3', name: 'M3 Super 90', price: 1700, teams: 'both', buyCategory: 'shotgun', killReward: 300, damage: 20, fireRate: 1.1, magazineSize: 8, maxReserveAmmo: 32, reloadTime: 2.8, spread: 0.22, movementSpeedMultiplier: 0.86, armorPenetration: 0.3, headshotMultiplier: 1.5, range: 28, recoilKick: 1.7, moveInaccuracy: 0.18 },
  ...
  mp5: { id: 'mp5', name: 'MP5 Navy', price: 1500, teams: 'both', buyCategory: 'smg', killReward: 300, damage: 26, fireRate: 11, magazineSize: 30, maxReserveAmmo: 120, reloadTime: 2.2, spread: 0.06, movementSpeedMultiplier: 0.98, armorPenetration: 0.62, headshotMultiplier: 2.6, range: 52, recoilKick: 0.8, moveInaccuracy: 0.06 },
